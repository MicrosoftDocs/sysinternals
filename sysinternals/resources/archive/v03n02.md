...
Download Handle v2.0 at http://www.sysinternals.com/ntw2k/freeware/handle.shtml.
...
Download PsInfo v1.1 at http://www.sysinternals.com/ntw2k/freeware/psinfo.shtml.
...
Download PsExec v1.24 at http://www.sysinternals.com/ntw2k/freeware/psexec.shtml.
...
Download PsLogList v2.07 at http://www.sysinternals.com/ntw2k/freeware/psloglist.shtml.
...
View the Windows XP source layout and learn more about assertions at http://www.sysinternals.com/ntw2k/info/xpsrctree.shtml (note that the IE will display a warning about the page loading slowly. Dismiss it and you’ll see the tree).
...
Download DebugView v4.13 at http://www.sysinternals.com/ntw2k/freeware/debugview.shtml.
...
Download PageDefrag v2.1 at http://www.sysinternals.com/ntw2k/freeware/pagedefrag.shtml.
Download Contig v1.4 at http://www.sysinternals.com/ntw2k/freeware/contig.shtml.
...
0x8000FFFF "Catastrophic failure" Message with SQL Server ODBC Driver http://support.microsoft.com/support/kb/articles/Q243/3/49.ASP
...
Final pricing and the release date have not yet been finalized, but if you wish to be notified of the release send e-mail to mailto:video@... with the word “interest” in the subject. Or, watch http://www.sysinternals.com/video/ for details.
...
Open a command-prompt window, change the current directory to the root of your boot drive (the drive with \winnt on it), and type “dir /s”. While that’s running type F7+Enter a few times and then abort the listing by entering Ctrl-C. You’ll either immediately encounter a blue screen or a spontaneous reboot. Cool, huh? Unfortunately, unlike the trick that I previously reported, this one isn’t designed behavior, but rather a bug for which you can find a report at http://www.WindowsITsecurity.com/articles/index.cfm?articleID=22037.
...
You can see the abstracts to my talks and find a link to the Windows .NET Connections site at http://www.sysinternals.com/ntw2k/info/talk.shtml.
