...
I’m proud to say that the number of Microsoft Knowledge Base articles that refer users to SysInternals tools continues to grow. Here is the list of the recent additions I’ve tracked down.
   ...
   http://support.microsoft.com/support/kb/articles/Q243/5/83.ASP
   ...
   http://support.microsoft.com/support/kb/articles/Q242/1/31.ASP
   ...
   File is in Use
   http://support.microsoft.com/support/kb/articles/q245/0/68.asp?lng=eng&sa=allkb
   ...
   http://support.microsoft.com/support/kb/articles/q247/9/57.asp
