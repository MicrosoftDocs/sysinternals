...
- [Defrag Tools Shows](https://channel9.msdn.com/shows/defrag-tools)
  ...
  - [Defrag Tools: #1- Building your USB thumbdrive](https://docs.microsoft.com/en-us/shows/defrag-tools/building-your-usb-thumbdrive)
  - [Defrag Tools: #2- Process Explorer](https://docs.microsoft.com/en-us/shows/defrag-tools/2-process-explorer)
  - [Defrag Tools: #3- Process Monitor](https://docs.microsoft.com/en-us/shows/defrag-tools/3-process-monitor)
  - [Defrag Tools: #4- Process Monitor- Examples](https://docs.microsoft.com/en-us/shows/defrag-tools/4-process-monitor)
  - [Defrag Tools: #5- Autoruns and MSConfig](https://docs.microsoft.com/en-us/shows/defrag-tools/5-autoruns)
  - [Defrag Tools: #6- RAMMap](https://docs.microsoft.com/en-us/shows/defrag-tools/6-rammap)
  - [Defrag Tools: #7- VMMap](https://docs.microsoft.com/en-us/shows/defrag-tools/7-vmmap)
  - [Defrag Tools: #8- Mark Russinovich](https://docs.microsoft.com/en-us/shows/defrag-tools/live-teched-2014-mark-russinovich)
  - [Defrag Tools: #9- ProcDump](https://docs.microsoft.com/en-us/shows/defrag-tools/9-procdump)
  - [Defrag Tools: #10- ProcDump- Triggers](https://docs.microsoft.com/en-us/shows/defrag-tools/10-procdump-triggers)
  - [Defrag Tools: #11- ProcDump- Windows 8 & Process Monitor](https://docs.microsoft.com/en-us/shows/defrag-tools/11-procdump-windows-8-process-monitor)
  - [Defrag Tools: #12- TaskMgr and ResMon](https://docs.microsoft.com/en-us/shows/defrag-tools/12-taskmgr-resmon)
