...
|  **-t\[u\]\[v\]** |  Dump contents of specified certificate store ('\*' for all stores).<br />
Specify -tu to query the user store (machine store is the default).<br />
...
Add 'r' to open reports for files with non-zero detection.<br />
